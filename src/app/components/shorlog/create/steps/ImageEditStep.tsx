      ...
      <div className="flex w-full flex-col justify-between md:w-[260px]">
        ...
        <div className="mt-4 flex items-center justify-end gap-2">
          ...
          <button
            ...
            className="rounded-full bg-[#2979FF] px-4 py-2 text-xs font-medium text-white shadow-sm transition hover:bg-[#1f63d1] disabled:cursor-not-allowed disabled:bg-slate-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2979FF]"
          >
            {isUploading ? (
