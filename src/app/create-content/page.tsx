    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-indigo-50/50">
      <div className="mx-auto flex min-h-screen max-w-6xl flex-col px-4 py-8 md:px-8 md:py-12">
        ...
        <button
          ...
          className="mb-6 inline-flex items-center gap-2 text-sm text-slate-600 transition-all hover:text-slate-800 hover:translate-x-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#2979FF] focus-visible:ring-offset-2 focus-visible:ring-offset-slate-50"
        >
          <ArrowLeft size={18} />
          뒤로가기
        </button>
        ...
        {/* 중앙 선택 카드 */}
        <div className="flex flex-1 items-center justify-start ml-16">
          <div className="w-full max-w-[680px] rounded-[2rem] bg-white/80 backdrop-blur-sm px-10 pb-10 pt-10 shadow-[0_32px_64px_-12px_rgba(0,0,0,0.25)] ring-1 ring-white/20 border border-white/30">
            ...
            <div className="flex justify-center">
              <button
                type="button"
                onClick={handleGoBack}
                className="inline-flex min-w-[160px] items-center justify-center rounded-2xl bg-slate-100/80 backdrop-blur-sm px-8 py-3 text-sm font-medium text-slate-600 shadow-lg transition-all hover:bg-slate-200/80 hover:scale-105 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-slate-400/30"
              >
                취소
              </button>
            </div>
