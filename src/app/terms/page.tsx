        ...
        <div className="mt-8 space-y-4">
          ...
          <Section id="service" title="5. 서비스 제공과 변경/중단">
            <BulletList
              items={[
                <>
                  TexTok은 블로그/숏로그 작성·열람, 댓글/좋아요/북마크, AI 기반 글 작성 도우미,
                  프로필 설정 등의 기능을 제공합니다.
                </>,
                <>
                  TexTok은 서비스 품질 향상 및 개인화된 추천 제공을 위해 이용 기록(예: 최근 본
                  게시물 기록 등)을 활용할 수 있습니다. 상세 내용은 개인정보 처리방침을 따릅니다.
                </>,
                <>
          ...
          <Section id="content" title="6. 콘텐츠의 권리와 이용 허락">
            ...
            <BulletList
              items={[
                ...
                <>
                  회원이 AI 기반 작성 도우미에 입력한 텍스트 및 AI가 생성한 텍스트 결과물은 서비스
                  제공을 위해 처리될 수 있습니다.
                </>,
                <>
                  회원이 AI 생성 결과물을 편집·선택하여 게시하는 경우, 해당 게시 콘텐츠의 권리는
                  회원에게 귀속됩니다.
                </>,
              ]}
            />
            ...
            <BulletList
              items={[
                ...
                <>
                  ...
                  <br />
                  (AI 기반 작성 도우미로 생성한 콘텐츠도 동일하게 금지됩니다)
                </>,
          ...
          <Section id="liability" title="10. 책임에 대한 안내(베타 서비스 특성)">
            <BulletList
              items={[
                ...
                <>
                  AI 기반 작성 도우미의 생성 결과는 오류·누락·편향이 있을 수 있으며, TexTok은 생성
                  결과의 정확성·적법성·신뢰성을 보증하지 않습니다.
                </>,
                <>
                  회원은 AI 생성 결과물을 게시하거나 활용하기 전에 스스로 사실 여부 및 권리 침해
                  가능성을 확인해야 합니다.
                </>,
                <>
